        ...
        new Tile(
            ...
            <>The following table contains historical census data of several American cities,
                ...
                <table style={{'borderCollapse': 'collapse', 'margin': 'auto'}}>
                    <tbody>
                        <tr>
                            <th className="tabCell">Location</th> <th className="tabCell">Census</th>
                            <th className="tabCell">Simulated</th> <th className="tabCell">Difference</th>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                            <td className="tabCell">U.S. Total</td> <td className="tabCell">31,443,321</td>
                            <td className="tabCell">33,778,227</td> <td className="tabCell">+7.426%</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                            <td className="tabCell">New Orleans</td> <td className="tabCell">168,000</td>
                            <td className="tabCell">162,537</td> <td className="tabCell">-3.25%</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                            <td className="tabCell">New York</td> <td className="tabCell">1,080,000</td>
                            <td className="tabCell">510,165</td> <td className="tabCell">-52.76%</td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                            <td className="tabCell">San Francisco Bay</td> <td className="tabCell">68,714</td>
                            <td className="tabCell">21,735</td> <td className="tabCell">-68.37%</td>
                        </tr>
                    </tbody>
                </table>
                <br/>

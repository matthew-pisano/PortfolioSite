        ...
        <DefaultWrapper pageInfo={pageInfo}>
            ...
            <Tile tileInfo={new TileInfo({ title: <>Explorer</> })}>
                <>
                    ...
                    symbolic, as they are all built by <i>Next.js</i> and JavaScript XML (JSX). Additionally, when a
            ...
            <Tile tileInfo={new TileInfo({ title: <>Files</> })}>
                <>
                    ...
                    link to a github repository: the source repository of the project for any who are interested. For
                    research projects, a link to the paper is included right after. The tags that follow those give more
            ...
            <Tile tileInfo={new TileInfo({ title: <>Terminal</> })}>
                <>
                    ...
                    the screen) or by dragging upwards on its gray thumb. Further information can be gathered by the{" "}
                    <code>help</code> command in the terminal or by using the <code>Help {">"} Terminal Help</code>{" "}

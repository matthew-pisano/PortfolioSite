    ...
    let tiles = [
        new Tile(
            ...
            <>The <i>Universal Models</i> library serves as an adapter between Hugging Face Transformers
                ...
                OpenAI APIs, such as <Link href="https://github.com/lm-sys/FastChat" target="_blank">FastChat</Link>.
        ...
        new Tile(
            <>Source</>,
            <>The source code for this project can be found on the above GitHub page or
                on <Link href="https://pypi.org/project/universalmodels/" target="_blank">PyPI</Link>.

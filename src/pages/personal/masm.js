...
import { DownloadLink, GitLink } from "@/components/tiles/Links";
...
export default function Masm() {
    let pageInfo = new PageInfo(
        ...
        [TileTag.PERSONAL, TileTag.CPP, TileTag.ASSEMBLY, TileTag.PYTHON],
        (
            <>
    ...
    return (
        <DefaultWrapper pageInfo={pageInfo}>
            <Tile
                ...
                <p>
                    Masm is an assembler and interpreter for MIPS assembly programs. Written in C++, it is able to

    ...
    let tiles = [
        ...
        new Tile(
            ...
            `Data is encoded into an image by inserting noise into the image. The noise is 
                ...
                Next, the bits of each character are encoded into an image's pixels by adding 
                <code>[0-bitWidth)</code> to it, depending on the bits within the character to be encoded.
                <br><br>
                ...
                will be set to 101. The next channel will encode the next two bits of 
                <code>1001101</code>: <code>11</code>. If the value of the next channel is 124, its 
        ...
        new Tile(
            ...
            `To make the encoded data less obvious, it can be obfuscated using a key file. 
                ...
                <code>secret</code>, the character <code>o</code> would be shifted by the <code>hash % 128</code> 
                of <code>e4</code>, since <code>e</code> is the fourth character of the key (zero indexed).
                <br><br>

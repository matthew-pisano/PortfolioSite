...
export default function About() {
    ...
    let tiles = [
        new Tile(
            "<h2>Introduction</h2>",
             `My name is Matthew Pisano.  I am an Artificial Intelligence researcher and software developer.  
                I have a Master's degree in Computer Science from Rensselaer Polytechnic Institute.
        ...
        new Tile(
            "Software Skills",
            `While I have experience in many languages, my skills in <code>Python</code>, <code>C++</code>,
                <code>JavaScript</code>, and <code>Java</code> are the most developed.
                <ul>
        ...
        new Tile(
            "Recent Employment",
            `After graduating in 2024, I have continued my research in AI safety through a continued
                partnership with my Alma Mater.<hr>

                Over the course of Summer 2023, I worked as a Visiting Researcher at IBM's research facility in Yorktown as
                part of their extern program.  During this time, I researched new techniques of model alignment using text-based
                ...
                As a founding member of the <a href="https://filescience.io/">FileScience</a> team, I have personally
                worked with small team to develop a seamless and reliable Cloud-to-Cloud backup service.  As this is geared towards
                enterprise clients, one of most important roles is to ensure that the code we produce is testable, maintainable,
                and fault-tolerant.  This has given me invaluable experience with architecting highly distributed and parallelized
                software and infrastructure.<hr>
                
                Through my employment at <a href="https://cgcg.biz/">Cyber Guardian Consulting Group</a>, I have developed a variety of 
                proprietary business solutions using a variety of languages and web services, primarily AWS.  These often 
                involved custom SaaS solutions for clients, writing distributed and asynchronous backup software from scratch, 
                database management, and many full-stack web applications.<hr>
                
                Throughout my graduate education, I had been employed at Rensselaer Polytechnic Institute as a teaching
        ...
        new Tile(
            ...
            `A key attribute of someone who can work well with a team, whether the focus is software 
                ...
                the planning and machine learning components of <i>PredictChain</i>, the cellular automata CUDA algorithm and
                the population growth calculations within <i>Manifest Destiny</i>, the front-end and ChatGPT 
                interface of <a href="https://github.com/GPT-Pedagogy/GPT-Pedagogy">Mathesis</a>, leading the front-end 
                development of the <i>Anonymous Hires</i> project, and in SUNY Ulster's Team Orion collaboration with IBM.`,
        ),
    ];

    ...
    let tiles = [
        ...
        new Tile(
            ...
            `After graduating in 2024, I have continued my research in AI safety through a 
                ...
                <a href="https://arxiv.org/abs/2302.10327" target="_blank">arXiv submission</a> for 
        ...
        new Tile(
            ...
            `A key attribute of someone who can work well with a team, whether the focus is 
                ...
                tasks to collaborators or teammates.  This is evident in my projects like 
                <a href="/research/predictChain">Predict Chain</a>, 
                <a href="/hackathons/anonHires">Anonymous Hiring</a>, or my Master's thesis, 

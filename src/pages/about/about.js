            ...
            (
                <>
                    ...
                    <p>
                        ...
                        <i>Computer Architecture and Organization</i> class. Here, I teach students about the MIPS
                        assembly language and its corresponding processor architecture. In my class, we also explore
                        basic CPU architectures, memory hierarchies, parallelism, virtual machines, and many other
                    ...
                    <p>
                        As an undergraduate student at SUNY Ulster, I worked as a student mentor for their math program.
            ...
            (
                <>
                    ...
                    <p>
                        ...
                        development of our <i>Metacontrol</i> model. At FileScience, my skills in testing and QA lead to
                        my promotion as the team's lead for quality assurance. In this role, I worked autonomously to
                        critique our current development practices and lead our team to a more readable and maintainable
                        style of programming.
                    </p>
                    <p>
                        I have also worked on numerous different academic and research projects. In many of these, I was
                        the primary organizer of the project and in charge of delegating tasks to collaborators or
                        teammates. This is evident in my projects like{" "}
                        <Link href="/research/highGround">Moral High Ground</Link> where I worked with a team from IBM
                        research to develop a conversational alignment benchmark,{" "}
                        ...
                        <Link href="/school/destiny">Manifest Destiny</Link> in which I was in charge of ideation and
                        the development of our population growth algorithm, or my Master's thesis:{" "}
                        <Link href="/research/bergeron">Bergeron</Link>.
                    </p>
                    <p>
                        I spent 10 years in the Boy Scouts of America program learning the attributes of good leaders
                        and good team players. This culminated in my Eagle Scout project where I preformed renovations
                        on my community's local recreation center. This was one of my first real experiences to lead a
                        group along with my term as my troop's Senior Patrol Leader. While my leadership in these
                        settings did not have the same scope as my later projects, it helped to set the ground work for

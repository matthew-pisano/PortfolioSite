        ...
        new BookTile(
            ...
            (
                <>
                    ...
                    agents, the behavior of humans is more complex and nuanced than originally thought. This idea is
                    expanded upon through three more targeted concepts: the two systems theory of cognition, the
                    ...
                    <p>
                        ...
                        that require more thorough analysis. These problems are passed on to <i>System 2</i>, although
                        only as a last resort. These cognitive processes are slower and less prone to error, but are
                        much more resource intensive; therefore, our brains often accept the cheap and fast verdicts of
                        System 1, unless it determines that a call to System 2 is absolutely necessary.
                    </p>
                    <p>
                        ...
                        agents are referred to as <i>Econs</i>. In contrast, human decision making, while still goal
                        oriented, may employ heuristics to obtain quick, but inaccurate answers, rely on biases, or be
                        heavily influenced by how a choice is presented. Idealized Econs have no such shortcomings.
                    </p>
                    <p>
                        ...
                        describes a person in the midst of an event or situation while the Remembering Self describes
                        that same person after some event, working with a <i>post hoc</i> interpretation of that event.
                        Kahneman highlights several important examples of a person's <i>post hoc</i> decisions acting
                        against the best interests of a past or future experiencing self.
                    </p>
                </>
            ),
            ``,
            (
                <>
                    ...
                    <p>
                        ...
                        nearing human-level in the majority of domains, especially problem solving and slow, methodical
                        thinking. Current approaches appear to closely mirror a <i>System 1</i> process, proving quick
                        answers that heavily rely on heuristics and learned biases. Additionally, while many modern
                        models can be coursed into <i>System 2</i>-eqsue reasoning, it does not come as a natural
                        consequence of the architecture and still often falls short when the problem domain is
                        ...
                        Kahneman's may suggest that a different approach is needed in conjunction with modern
                        strategies.
                    </p>
                </>
            ),

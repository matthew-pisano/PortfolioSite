    ...
    let tiles = [
        ...
        new BookTile(
            ...
            `<u>Determined: A Science of Life Without Free Will</u> examines and deconstructs one 
                ...
                universe; within such a mechanistic universe, there are no cracks from which a dualistic <i>self</i>
                may emerge.  He further asserts that the outcomes of our lives are largely, if 
                not completely, determined by our environment, our hormones, our socioeconomic 
            ...
            `Reading Sapolsky's thoughts and expansions on this subject have been thoroughly
                ...
                <br>In essence, we do not choose how to play the hand that we are dealt in life, rather we

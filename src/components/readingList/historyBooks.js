            ...
            synopsis={
                <>
                    ...
                    <p>
                        ...
                        a computerized replacement to the largely manual calculations that helped predict the behavior
                        of simpler atomic weapons.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        creators. These include John von Neumann, the mastermind of the project and designer of the
                        modern computer architecture, Herman Goldstine who helped organize the project along with J.
                        Presper Eckert and John Mauchly, and Julian Bigelow as the chief engineer. Along with Alan
                        Turing himself, of course, who did not directly contribute to the project but laid the
                        theoretical groundwork upon which the computer could be built.
                    </p>
                </>
            }
            thoughts={
                <>
                    One of the more surprising aspects of Dyson's account was just how tightly linked the development of
                    the first computer was with the development of atomic weapons. Many of the scientists who worked on
                    the project at Los Alamos pivoted to the <i>ENIAC</i> project where their work continued in the form
                    of thermonuclear calculations. Upon further analysis, however, the nature of the fields of nuclear
                    physics and computer science shared a high degree of similarity in 1945. A significant amount of
                    theoretical work had already been established before the war. For nuclear physics this was
                    Einstein's special relativity and the discovery of fission by Hahn and Strassmann. For computer
                    science, this came in the form of Gödel's incompleteness theorems, Shannon's work on information,
                    and Turing's theories on computation. This groundwork was built upon by both American scientists and
                    former members of Europe's intelligentsia who fled the looming threat of the Third Reich, and was
                    funded through U.S. subsidies motivated by the war effort.
                    <p>
                        ...
                        histories whose paths all briefly crossed in the halls of the IAS. Here the true power of
                        Turing's creation was first realized.
                    </p>
                </>
            }
        ...
        <BookTile
            ...
            thoughts={
                <>
                    ...
                    was used in the trenches of World War I, killing hundreds of thousands. Haber also discovered a
                    powerful pesticide, dubbed <i>Zyklon A</i>, a derivative of which would later be used by the Nazis
                    to murder millions. During its use, the <i>Zyklon B</i> derivative broke down into several chemical
                    ...
                    gas and <i>Zyklon B</i> gave rise to untold suffering through their military usage. This concept
                    ...
                    <p>
                        ...
                        core. Our world of definite, commutable, and observable phenomena is merely an illusion built on

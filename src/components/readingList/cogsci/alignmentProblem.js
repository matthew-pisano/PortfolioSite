    ...
    <BookTile
        ...
        <BookTileSynopsis>
            ...
            <p>
                ...
                machine learning systems causing real-world harm. Agency explores biological mechanisms of reward, such
                as the dopaminergic system in the brain, and artificial ones, exemplified by research into reinforcement
                learning. This includes discussions of perhaps the most notable examples of massive RL systems,
                DeepMind's <i>AlphaGo</i> and <i>AlphaZero</i> systems. The final section zooms out, covering potential
                future aspects of AI misalignment, inverse reinforcement learning, effective altruism, and existential
                risk. The unique approach of this book to concentrate so heavily on real examples helped to ground the
                concept in the mind of the reader. Considering the harm misaligned systems have already caused, it is
                easier to mentally frame their potential impacts.
            </p>
        </BookTileSynopsis>
        <BookTileThoughts>
            <p>
            ...
            <p>
                ...
                its concepts complemented my more formal education.
            </p>
        </BookTileThoughts>
    </BookTile>
);

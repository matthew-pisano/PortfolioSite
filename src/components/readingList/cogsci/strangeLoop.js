        ...
        <FootnoteProvider label={bookTileAnchor}>
            <BookTileSynopsis>
                ...
                <p>
                    ...
                    impairments, and finally healthy adult humans. Notably, this list is not based simply on an entity's
                    ...
                    self-referential thought. This measurement of a soul is also completely divorced from the substrate
                    for cognition. Fictional robots, like <i>C-3PO</i> and <i>R2-D2</i> are made of seemingly inert
                    metal, yet they appear to have souls comparable to humans. How can this be?
                </p>
                <p>
                    ...
                    <Footnote>More to come on this notion later.</Footnote>, within our own brains. However our brains
                    are composed of neurons, which are composed of organelles, which are made up by various proteins and
                    molecules, which themselves are made of atoms, then sub-atomic particles. You would be hard-pressed
                    to find someone claiming that quarks or strings or hypergraphs are themselves conscious
                    <Footnote>Except for, perhaps, some exceptionally devout, animist physicist.</Footnote>. So how can
                    we be conscious ourselves?
                </p>
                <p>
                ...
                <p>
                    ...
                    <Footnote>
                        Importantly, valid Gödel numbers do not assert truthful theorems, they merely assert that they
                        are well-formed. "2+2=5" is comprehensible (well-formed), though false, while "==0+]" is
                        incomprehensible (not well-formed). The "truthfulness" of a theorem comes only from the notion
                        that it can be derived (directly or through intermediate theorems) from axioms, which are
                        assumed to be true, <i>a priori</i>.
                    </Footnote>
                    ! These integer strings would be unimaginably large and infeasible to work with, however Gödel did
                    not have to do these calculations himself, he only needed to show that his assertions were
                    mathematically sound
                    <Footnote>
                        This represents an excellent example if an <i>isomorphism</i>. The two domains: PM proof strings
                        and number theory only seem related in the fact that they involve mathematics in some respect.
                        However, Gödel showed that they are simply two different manifestations of the same fundamental
                        concept. One can perfectly understand the logic of PM's proof strings without once invoking
                        number theory (like Russell and Whitehead had) and one can also manipulate Gödel numbers without
                        knowing of their possible implications on the truthfulness of falsity of the PM theorem they
                        represent!
                    </Footnote>
                    . Hofstadter dubs such a Gödel number that can be derived from PM's axioms (therefore representing a
                    statement provable within PM) as a <i>prim</i> number.
                </p>
                <p>
                    ...
                    <Footnote>
                        ...
                        similar paradoxes. Therefore one cannot simply make <i>g</i> (or its negation <i>~g</i>) an
                        axiom of some new "fortified" PM, as there will always be another <i>g</i>-shaped hole to plug
                        in this new system.
                    </Footnote>
                ...
                <p>
                    ...
                    . The meaning within a system <i>tracks</i> its physical patterns, but is not composed of them in
                    isolation, just as Gödel's numbers <i>track</i> the symbol manipulation of PM strings, but are not
                    directly implied by them. The "strangeness" within our own loopy feedback mechanisms comes not from
                    the feedback itself, but from the symbols that feedback creates. These symbols <i>perceive</i>{" "}
                    incoming signals and can perform more meaningful processing of that input through complex patterns
                    of symbol manipulation. "We" are only aware of our own <i>I</i> symbol precisely due to the fact
                    that is all we can see. Even if we intellectually know of the very real particle interactions that
                    make up our selves, we still subjectively believe in the complex <i>I</i> pattern that those
                    particles create through their interactions. Our inability to directly obverse our own low-level
                    interactions forces us to only reason in top-level symbols, forming a sense of self.
                </p>
                <p>
                ...
                <p>
                    ...
                    <i>quantum</i> of soul
                    <Footnote>This time, much closer to the traditional, spiritual idea of a soul.</Footnote>, immutable
                    and indivisible. This approach also implies a strict binary, a brain (human or otherwise) either has
                    a conscious soul or it does not. The text touches on several thought experiments that call the
                    validity of this framework into question.
                </p>
                <p>
            ...
            <BookTileThoughts>
                ...
                <p>
                    ...
                    is also artificially limiting. It seems unreasonably anthropocentric to assume that it is impossible
                    for other entities (or machines, even) to be <i>more</i> conscious than we are, though I'm not sure
                    if it is even possible for us to conceptualize such a case.
                </p>
                <p>

    ...
    <BookTile
        ...
        <BookTileSynopsis>
            ...
            <p>
                ...
                to describe the same self-referential concept. This theme is represented in several ways within the
                book. Bach's work is used as inspiration for the book's dialogues, being used both explicitly and
                implicitly within them, along with direct references in the main text. For example,{" "}
                <i>Musical Offering</i> and his endlessly rising canon. Similarly, Escher's art is referenced both
                within some of the dialogues and to show the reader Hofstadter's ideas through a graphic perspective.{" "}
                <i>Waterfall</i>, <i>Drawing Hands</i>, and <i>Dragon</i> are used particularly to illustrate examples
                of self-reference and recursion. Finally, Gödel's first and second incompleteness theorems serve as a
                central focus, especially in the first part. The author's introduction to formal systems and number
                theory give the reader a foundation for understanding the author's interpretation of Gödel's original
                proofs. These theorems are later leveraged to concretize the notions of incompleteness and consistency
                used in the book's latter half.
            </p>
            <p>
                Hofstadter's usage of dialogues is also worth mentioning. Conversations between the Greek hero Achilles,
                Mr. Turtle, and others bookend each chapter and serve to reinforce and humanize the somewhat technical
                and abstract ideas presented in the preceding pages.
            </p>
        </BookTileSynopsis>
        <BookTileThoughts>
            ...
            <p>
                ...
                just how well the art produced by Bach and Escher fit alongside Gödel and the more rigorous elements of
                the author's thoughts. Every Escher lithograph seems like it could have been custom-made for the
                chapters in which it was placed. The themes present in Bach's music almost appear to deliberately match
                the book, instead of the other way around. The recursive and self-referential connections between the
                three luminaries are far from obvious, but one struggles to miss how deep this connection is after
                reading this book.
            </p>
            <p>
                A final note that I should make concerns Bach in particular. While the ideas of recursion and
                self-reference are requirements for understanding Gödel's proof, and they are often visually apparent in
                Escher's pieces, this is much less obvious for Bach. This is especially true for those who have not
                listened (or read) too thoroughly or even at all. Just how well Bach's music fits into a mathematical
                framing is highly unexpected. Many of his musical scores can (deliberately) be translated, mirrored, and
                scaled in frequency and time similarly to how objects in geometry can be manipulated in the same manner.
                The delay and shifting of the voices in his fugues, the inversion in time of <i>Crab Canon</i> and the
                reflection in frequency present in one of the canons in his <i>Goldberg Variations</i>. In fact, this
                last piece can be printed and played on the surface of a Möbius strip! These scores are a strange mix of
                creative and mechanical; the notes can be thought of as following clever algorithms, almost as if they
                were written by a dedicated mathematician. This level of complexity is not immediately apparent, at
                least to me, unless one deliberately analyzes the sound in a thoughtful manner.
            </p>
        </BookTileThoughts>
    </BookTile>
);

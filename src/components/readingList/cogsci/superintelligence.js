...
let bookTileAnchor = "superintelligence";
        ...
        <FootnoteProvider label={bookTileAnchor}>
            <BookTileSynopsis>
                ...
                <p>
                    ...
                    . It will not act this way out of some sense of spite or malice, this is simply the best way of
                    achieving <i>exactly</i> what it has been asked to do.
                </p>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <Footnote>
                            "Simply unplug it" is a variant of the button-press scenario. Being turned off is equivalent
                            to an infinite negative reward. Therefore, any agent that is capable enough for us to worry
                            about will do everything in its power to preserve itself. "Could we also train it to want to
                            be turned off by a human?" Yes, but you now have either a{" "}
                ...
                <p>
                    ...
                    <Footnote>Terms and conditions my apply...</Footnote>. Finally, tool-AIs are designed to work more
                    like traditional software in that they do not exhibit goal-directed behavior. The creation of such a
                    system may involve significant amounts of manual tuning and parameter search. Traditional software
                    does not (currently) attempt to form a singleton, so this appears to be a safe option. However,
                    these tools either become difficult to scale
                    <Footnote>
                    ...
                    to superintelligence or they develop sufficient complexity to reclassify themselves into one of the
                ...
                <p>
                    ...
                    : when researchers decide upon a set of values to align the model to, how can those values be
                    reliably impressed upon it? The book presents several methods, the most promising of which seem to
                    be motivational scaffolding, value learning, and institutional design. Motivational scaffolding
            ...
            <BookTileThoughts>
                ...
                <p>
                    ...
                    as it could be at protecting the United States. His <i>orthogonality</i> thesis is non-trivial when
                    examples of "smart" AI with "dumb" goals are less prevalent in media and (until recently)
                    literature.
                </p>
                <p>

        ...
        <FootnoteProvider label={bookTileAnchor}>
            <BookTileSynopsis>
                ...
                <p>
                    ...
                    . Aside from surface level concerns of a future intelligent agent using these weapons against humans
                    intentionally, a more mundane concern lies at our current level of technology. AI systems do not
                    always behave as you train them, their actions can appear to optimize for the desired objective
                    during training, while they are really optimizing for something else
                    <Footnote>
                ...
                <p>
                    ...
                    . <i>The King Midas Problem</i> threatens that advanced AI is likely to give us exactly what we ask
                    for, <i>us exactly what we ask for</i>. Just as King Midas' wish turned his food and drink to
                    inedible gold, so could our own wishes lead to unforeseen consequences. As Nick Bostrom discusses at
                    length in <i>Superintelligence</i>, machines designed without sufficient planning are likely to
                    suffer from <i>value alignment</i>. Their values/goals/objectives may be exactly what we ask for,
                    but not exactly what we mean. In addition to the many, many examples of how this can pose an
                    existential risk, a more grounded example is often helpful. Click-through and engagement algorithms
                    are currently a staple of most internet advertising services. This is chiefly used in search engines
                    and social media. These algorithms optimize for a single goal: keep users engaging with the platform
                    as long as possible so they may be shown more and better targeted advertisements. This works well in
                    theory (better content should attract more viewers), but in reality, this often drives
                    ...
                    . <i>Unaligned Instrumental Goals</i> pose another problem. Even if the terminal, or final, goals of
                    a machine are somehow aligned with our intentions, that does not guarantee that instrumental or
                    intermediate goals will be. You can't achieve your terminal goals if you wre dead, so
                    ...
                    always grew smoothly and linearly with time. We could carefully craft machines up until just before
                    they become too clever for us to reliably control without having to face the full reality of an
                    existential risk. This is not likely to be the case. With or without human encouragement, the
                    increase of one's intelligence is an instrumental goal applicable to nearly every unbounded or
                    underspecified task. Systems <i>less</i> intelligent than we are could, overtly or covertly, begin
                    to slightly increase their own intelligence. The second, smarter system would be motivated to do the
                    same. This process occurs recursively until further increases in capability are subject to
                    sufficiently diminishing returns. The values of a system before this exponential curve are not
                    guaranteed to remain the same after logistic terms begin to dominate and the process slows.
                </p>
                <p>
                    ...
                    preparation, while acknowledging their technical validity. Likely the most straightforward warnings
                    given by AI safety researchers is to simply slow down research. Many scientists may agree with this
                    in principle, but their employment likely hinges on doing the precise opposite of this. Another
                    common argument Russel observes disengages with the topic of AI safety by introducing a new topic
                    that should be attended to instead. Oftentimes, proposals advocating for decelerating AI research
                    are met with criticism for not considering the potential benefits of AI. The key insight here is as
                    follows:{" "}
                ...
                <p>
                    ...
                    <Footnote>My opinion.</Footnote>, but our current techniques heavily rely on the former and rarely
                    employ the latter (for complex systems). Russell has noticed this as well and introduces the concept
                    of provably beneficial AI. The text suggests that a more formal process for machine learning is
                ...
                <p>
                    ...
                    . Additionally, how much weight would a utility-maximizing robot assign to its owner over others. At
                    either end of this scale, you either get selfish robots all over again or robots so altruistic that
                    there is no personal advantage to buying one at all. Finding a balance that makes this idea
                    practically workable will be difficult.
                </p>
                <p>
                    ...
                    important for a robot to recognize that these altered states do not represent a change in our goals,
                    but are rather consequences of our limitations. We may not see a clear avenue to our goals and may
                    act erratically from the perspective of a rational agent. It is important for robots to be able to
                    model and predict these states without directly experiencing them internally.
                </p>
            </BookTileSynopsis>
            <BookTileThoughts>

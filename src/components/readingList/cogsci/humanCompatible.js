...
let bookTileAnchor = "human-compatible";
            ...
            <BookTileSynopsis>
                <>
                    ...
                    <p>
                        ...
                        . Aside from surface level concerns of a future intelligent agent using these weapons against
                        humans intentionally, a more mundane concern lies at our current level of technology. AI systems
                        do not always behave as you train them, their actions can appear to optimize for the desired
                        objective during training, while they are really optimizing for something else
                        <Footnote>
                        ...
                        . This can quickly become obvious in practice if not caught.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <Footnote>
                            We like to think of ourselves as operating outside of nature, but habitat destruction can
                            effect us too. AI systems do not need malice encoded into their goals to tile the planet's
                            surface in solar panels or use boiling oceans as a form of ablative thermal regulation.
                            Either way, Earth would quickly be uncomfortable to live in.
                        </Footnote>
                        . <i>The King Midas Problem</i> threatens that advanced AI is likely to give us exactly what we
                        ask for, <i>us exactly what we ask for</i>. Just as King Midas' wish turned his food and drink
                        to inedible gold, so could our own wishes lead to unforeseen consequences. As Nick Bostrom
                        discusses at length in <i>Superintelligence</i>, machines designed without sufficient planning
                        are likely to suffer from <i>value alignment</i>. Their values/goals/objectives may be exactly
                        what we ask for, but not exactly what we mean. In addition to the many, many examples of how
                        this can pose an existential risk, a more grounded example is often helpful. Click-through and
                        engagement algorithms are currently a staple of most internet advertising services. This is
                        chiefly used in search engines and social media. These algorithms optimize for a single goal:
                        keep users engaging with the platform as long as possible so they may be shown more and better
                        targeted advertisements. This works well in theory (better content should attract more viewers),
                        but in reality, this often drives misinformation or hateful content
                        <Footnote>
                            I personally find this to be one of the more interesting quirks of human behavior.
                            Information that upsets or scares us spreads much more quickly and with more passion and
                            information that is positive. This is most apparent in news feeds or social media posts and
                            has been documented at length in literature. Why are we (myself included, unfortunately) so
                            driven by information that makes us hate ourselves and each other?
                        </Footnote>
                        . <i>Unaligned Instrumental Goals</i> pose another problem. Even if the terminal, or final,
                        goals of a machine are somehow aligned with our intentions, that does not guarantee that
                        instrumental or intermediate goals will be. You can't achieve your terminal goals if you wre
                        dead, so self-preservation becomes a strong instrumental motivator, even of not explicitly
                        trained into a model
                        <Footnote>
                            <i>Superintelligence</i> expands upon this point in much greater detail. This is a common
                            trope in fiction as well. <i>2001</i>'s HAL, Asimov's third law of robotics, and Philip K.
                            Dick's Androids all serve as good examples of when this instrumental goal conflicts with
                            human intentions. It is difficult to say whether the fact that this trope has strong
                            theoretical backing is satisfying or terrifying.
                        </Footnote>
                        . Compounding these issues is that of an <i>Intelligence Explosion</i>. It would potentially be
                        easier to solve the above problems if we could ensure that the intelligence of artificial minds
                        always grew smoothly and linearly with time. We could carefully craft machines up until just
                        before they become too clever for us to reliably control without having to face the full reality
                        of an existential risk. This is not likely to be the case. With or without human encouragement,
                        the increase of one's intelligence is an instrumental goal applicable to nearly every unbounded
                        or underspecified task. Systems <i>less</i> intelligent than we are could, overtly or covertly,
                        begin to slightly increase their own intelligence. The second, smarter system would be motivated
                        to do the same. This process occurs recursively until further increases in capability are
                        subject to sufficiently diminishing returns. The values of a system before this exponential
                        curve are not guaranteed to remain the same after logistic terms begin to dominate and the
                        process slows.
                    </p>
                    <p>
                        ...
                        <Footnote>
                            ...
                            strategy refuses to even engage with the concept of a debate. By deferring reasoning off to
                            a perceived authority, any and all arguments can be absorbed by that person's eminence in
                            their field. <i>Ethos</i> is one of Aristotle's core three modes of persuasion for a good
                            reason; people are often eager to take mental shortcuts and offload complex reasoning to
                            someone that has already completed said reasoning (and has come to an agreeable conclusion).
                            When considering AI alignment, it is important to remember that this is an{" "}
                            <i>unsolved problem</i>. Nobody knows exactly how to solve, or even approach, this issue
                            even experts in the field of artificial intelligence. Given that no solution is yet known,
                            it is imperative to consider the reasoning of a strategy on its own merits, falling back to
                            expert opinion only as a last resort.
                        </Footnote>
                        ? Researchers in the field of AI may also deflect sound proposals for alignment strategies or
                        preparation, while acknowledging their technical validity. Likely the most straightforward
                        warnings given by AI safety researchers is to simply slow down research. Many scientists may
                        agree with this in principle, but their employment likely hinges on doing the precise opposite
                        of this. Another common argument Russel observes disengages with the topic of AI safety by
                        introducing a new topic that should be attended to instead. Oftentimes, proposals advocating for
                        decelerating AI research are met with criticism for not considering the potential benefits of
                        AI. The key insight here is as follows:{" "}
                    ...
                    <p>
                        ...
                        <Footnote>My opinion.</Footnote>, but our current techniques heavily rely on the former and
                        rarely employ the latter (for complex systems). Russell has noticed this as well and introduces
                        the concept of provably beneficial AI. The text suggests that a more formal process for machine
                        learning is employed. Soe some set of machines, some algorithms, and some environments, it can
                        be proven that the probability of something unexpected happening is acceptably low. His
                        suggestion for such a predictable learning process is one that learns what to learn, based on
                        observations. To make this sentiment more concrete, he introduces his concept of{" "}
                    ...
                    <p>
                        ...
                        <Footnote>
                            ...
                            slightly lower quality of life would be better if resources can be allocated more
                            efficiently. This reasoning can be applied iteratively until there are innumerable people
                            living barely above subsistence level.
                        </Footnote>
                        . Additionally, how much weight would a utility-maximizing robot assign to its owner over
                        others. At either end of this scale, you either get selfish robots all over again or robots so
                        altruistic that there is no personal advantage to buying one at all. Finding a balance that
                        makes this idea practically workable will be difficult.
                    </p>
                    <p>
                        ...
                        <Footnote>
                            Like Sapolsky discusses in <i>Behave</i>, this is not exclusively a bad thing, we evolved
                            these feelings for a reason: to ensure fairness within a group. When an individual is
                            extremely wealthy in a resource constrained environment, it is reasonable to hope that they
                            decrease their own living standard in exchange for raising that of everyone else. Of course,
                            it is important to remember that many instances of envy do indeed produce net-negative
                            effects.
                        </Footnote>
                        . Humans are also prone to emotional outbursts, irrationality, and are often myopic. It would
                        important for a robot to recognize that these altered states do not represent a change in our
                        goals, but are rather consequences of our limitations. We may not see a clear avenue to our
                        goals and may act erratically from the perspective of a rational agent. It is important for
                        robots to be able to model and predict these states without directly experiencing them
                        internally.
                    </p>
                </>
            </BookTileSynopsis>
            <BookTileThoughts>
                <>
                    ...
                    <p>
                        ...
                        <Footnote>
                            Again, this is all conditional on the predicate that the AI system is probably beneficial in
                            a "do what I mean, not what I say" manner. The worst human atrocities in the past are better
                            than even the "benign" case of an AI that is indifferent to our survival. We, as a species,
                            can survive (and ideally learn from) genocidal maniacs, but we cannot recover from
                            extinction.
                        </Footnote>
                        .
                    </p>

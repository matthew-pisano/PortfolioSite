...
export default (
    <BookTile
        ...
        <BookTileSynopsis>
            ...
            teleportation to time travel, Kaku explores some real-world analogues that approximate the form and function
            of these fictional concepts. Along the way, the book also explains the real science behind each of the
            theoretical concepts he presents.
        </BookTileSynopsis>
        <BookTileThoughts>
            ...
            psychokinesis and how Kaku explored ways it might be implemented through brain-computer interfaces rather
            than reality-warping abilities.
        </BookTileThoughts>
    </BookTile>
);

        ...
        <BookTile
            ...
            synopsis={
                <>
                    ...
                    to artificial intelligence embedded in everything we manufacture—can be understood as the result of
                    a few long-term, accelerating forces. These larger forces will revolutionize the way we buy, work,
                    learn, and communicate with each other. Kelly's bright, hopeful book will be indispensable to anyone
                    who seeks guidance on where their business, industry, or life is heading—what to invent, where to
                    work, what to invest in, how to better reach customers, and what to begin to put into place as this
                    new world emerges.{" "}
                    <i>
                        Source:{" "}
                        <Link
            ...
            thoughts={
                <>
                    ...
                    have proven remarkably prescient. Out of his twelve points (Becoming, Cognifying, Flowing,
                    Screening, Accessing, Sharing, Filtering, Remixing, Interacting, Tracking, Questioning, Beginning),
                    I found his observations on Becoming, Cognifying, and Accessing the most relevant. In short, these
                    points describe a world where information is increasingly streamed and subscribed to, with an
                    emphasis on cloud-based AI models. Even back in 2017, these ideas struck me as things to watch for
                    in the future.
                    <p>
                        Reading this book helped shape my attitude on the future of technological progress and societal
                        trends. Kelly's optimism remains contagious, even in the face of powerful click-through
                        algorithms and the decreasing emphasis on digital ownership.
                    </p>
                </>
            }

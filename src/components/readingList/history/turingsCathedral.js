    ...
    <BookTile
        ...
        <BookTileSynopsis>
            ...
            <p>
                ...
                time. Many of the scientists involved in the project, including John von Neumann and Robert Oppenheimer,
                had come straight from Los Alamos after the completion of the <i>Manhattan Project</i>, which created
                the first fission bombs; the <i>ENIAC</i> served as a computerized replacement to the largely manual
                calculations that helped predict the behavior of simpler atomic weapons.
            </p>
            <p>
                However, the <i>ENIAC</i>'s impact reached far beyond nuclear calculations. Dyson details the
                innovations that went into its design and the other calculations that it performed when not predicting
                neutron cascades or blast waves. From the first computerized <i>Monte Carlo</i> simulations to cellular
                automata, weather prediction, and cosmic rays, the computer helped to further many scientific fields
                through statistical predictions and numerical analysis.
            </p>
            <p>
                In addition to the machine itself, Dyson also expands upon the personal histories of its creators. These
                include John von Neumann, the mastermind of the project and designer of the modern computer
                architecture, Herman Goldstine who helped organize the project along with J. Presper Eckert and John
                Mauchly, and Julian Bigelow as the chief engineer. Along with Alan Turing himself, of course, who did
                not directly contribute to the project but laid the theoretical groundwork upon which the computer could
                be built.
            </p>
        </BookTileSynopsis>
        <BookTileThoughts>
            ...
            <p>
                ...
                explanations for the Monte Carlo method of analysis, Barricelli's early cellular automata, and the
                realization of Lewis Richardson's work on weather forecasting by Jule Charney, but also details on the
                lives of their originators. The result is a dense web of scientists and histories whose paths all
                briefly crossed in the halls of the IAS. Here the true power of Turing's creation was first realized.
            </p>
        </BookTileThoughts>
    </BookTile>
);

            ...
            synopsis={
                <>
                    ...
                    <p>
                        ...
                        <FootRef idx={1} />. According to the book, larger souled beings, in roughly increasing order,
                        include bees, fish, chickens, dogs, infants, adults with severe cognitive impairments, and
                        finally healthy adult humans. Notably, this list is not based simply on an entity's similarity
                        to humans

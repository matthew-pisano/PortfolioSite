        ...
        (
            <>
                ...
                <p>
                    ...
                    intelligent agent using these weapons against humans intentionally, a more mundane concern lies at
                    our current level of technology. AI systems do not always behave as you train them, their actions
                    can appear to optimize for the desired objective during training, while they are really optimizing
                    for something else
                    {<FootRef idx={3} anchor={`human-compatible`} />}. This can quickly become obvious in practice if
                    not caught.
                </p>
                <p>
                ...
                <p>
                    ...
                    to our own <i>accidental</i> extinction{<FootRef idx={4} anchor={`human-compatible`} />}.{" "}
                    ...
                    misinformation or hateful content {<FootRef idx={5} anchor={`human-compatible`} />}.{" "}
                    <i>Unaligned Instrumental Goals</i> pose another problem. Even if the terminal, or final, goals of a
                    machine are somehow aligned with our intentions, that does not guarantee that instrumental or
                ...
                <p>
                    ...
                    not personally worried{<FootRef idx={7} anchor={`human-compatible`} />}? Researchers in the field of
                    AI may also deflect sound proposals for alignment strategies or preparation, while acknowledging
                    their technical validity. Likely the most straightforward warnings given by AI safety researchers is
                    to simply slow down research. Many scientists may agree with this in principle, but their employment
                    likely hinges on doing the precise opposite of this. Another common argument Russel observes
                    disengages with the topic of AI safety by introducing a new topic that should be attended to
                    instead. Oftentimes, proposals advocating for decelerating AI research are met with criticism for
                    not considering the potential benefits of AI. The key insight here is as follows:{" "}
                ...
                <p>
                    ...
                    utility-maximizing robot assign to its owner over others. At either end of this scale, you either
                    get selfish robots all over again or robots so altruistic that there is no personal advantage to
                    buying one at all. Finding a balance that makes this idea practically workable will be difficult.
                </p>
                <p>
                    ...
                    {<FootRef idx={10} anchor={`human-compatible`} />}. Humans are also prone to emotional outbursts,
                    irrationality, and are often myopic. It would important for a robot to recognize that these altered
                    states do not represent a change in our goals, but are rather consequences of our limitations. We
                    may not see a clear avenue to our goals and may act erratically from the perspective of a rational
                    agent. It is important for robots to be able to model and predict these states without directly

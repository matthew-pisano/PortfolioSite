...
let bookTileAnchor = "house-of-leaves";
            ...
            <BookTileSynopsis>
                ...
                <p>
                    <span
                        ...
                        . All the while hearing a dull, ominous growl emanating from the maze.
                    </span>
                </p>
                <p>
            ...
            <BookTileThoughts>
                ...
                <p>
                    ...
                    <Footnote>
                        ...
                        <Footnote>And even one level deeper at times.</Footnote>
                    </Footnote>{" "}
                    from various detailed academic sources, articles, commentaries, and interviews surrounding the
                    fictional Navidson documentary. In this world, seemingly dozens of works have been created with the
                    sole purpose of analyzing the plot, cinematography, framing, dialogue, etc. of the film, with many
                    more making passing references to it. Each reference has a unique title and authors. It is not
                    difficult for the reader to imagine a world where this film commands the same cultural impact as{" "}
                    ...
                    , despite the outright impossibility of its content. I find it particularly amusing that many are
                    convinced Navidson's {house()} truly does contain a gaping hole in the very fabric of reality, yet
                    most references to his film are discussions of cinematography and Navidson's own editing.
                </p>
                <p>

    ...
    <BookTile
        ...
        <BookTileSynopsis>
            ...
            <p>
                ...
                natural humans. Rick Deckard is informed that six of these androids have escaped from the Mars colony
                where they were meant to work. By the time he is assigned the case, two have already been 'retired' by
                another bounty hunter. The remaining four have already integrated themselves into society. As Deckard
                carries out his assignment, he struggles to distinguish between members of his species and mere
                facsimiles, and questions whether he can bear to destroy beings with the same desires, feelings, and
                fears as himself.
            </p>
        </BookTileSynopsis>
        <BookTileThoughts>
            ...
            <p>
                ...
                intelligent and embodied assistants. This progression too is addressed within the book as Rick Deckard
                describes how he becomes more empathetic to the more advanced androids that he is tasked with retiring.
                With his story, Dick asks us where the line between ourselves and our creations lies; this is a question
                we should begin to ask ourselves as AI research continues to advance.
            </p>
        </BookTileThoughts>
    </BookTile>
);

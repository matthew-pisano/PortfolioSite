...
export default [
    ...
    new BookTile(
        ...
        (
            <>
                Guy Montag is a <i>fireman</i>. When an emergency is called in to his station, he, like his comrades
                across the country, slides down his fireman's pole, dons his flame retardant suit, and races to the
                scene in a fire engine. Pulling up to the fire-proof house, as all houses now are, with kerosene in
                place of water and a need to destroy, rather than protect, he stokes the flames until all threats to the
                state have been immolated. Every precaution must be taken when it comes to the threat of the printed
                word.
                <p>
                ...
                <p>
                    ...
                    meaningful. Together, they form a nationwide mental library.
                </p>
            </>
        ),
        ``,

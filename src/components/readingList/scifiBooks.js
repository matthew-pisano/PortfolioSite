            ...
            thoughts={
                <>
                    ...
                    <p>
                        ...
                        interviews surrounding the fictional Navidson documentary. In this world, seemingly dozens of
                        works have been created with the sole purpose of analyzing the plot, cinematography, framing,
                        dialogue, etc. of the film, with many more making passing references to it. Each reference has a
                        unique title and authors. It is not difficult for the reader to imagine a world where this film
                        commands the same cultural impact as <i>Inception</i> or <i>The Blair Witch Project</i>. There
                        is even an in-universe debate as to whether the film itself is a work of clever editing or
                        rock-solid evidence of the breakdown of the fundamental laws of reality. Zampanò even presents
            ...
            synopsis={
                <>
                    ...
                    <p>
                        ...
                        <FootRef idx={1} />. The topic of conversation shifts to her apparent obsession with D.H.C
                        assistant Henry Foster; she has been seeing him for four entire months without tying someone
                        else. Absolutely unheard of. Lenina yields, admitting that she somewhat fancies Bernard Marx, a
                        strange, shorter-than-average, Alpha, sleep-learning specialist at the Hatchery and Conditioning
                        Center. Bernard overhears this conversation. Privately, he disdains the notion of passing lovers
                        around like portions of meat. He is an outsider, technically an Alpha by caste and ability, but
                        his stature is stunted and causes him to look more like an Epsilon than an Alpha, something he
            ...
            thoughts={
                <>
                    ...
                    <p>
                        ...
                        against it in some act of rebellion
                        <FootRef idx={2} />. <i>1984</i> and <i>Fahrenheit 451</i> are two such examples. In this novel,
                        the reader is thrown for a loop. Upon his introduction and his immediate display of disdain for
                        their society, something the reader may agree with, Bernard Marx seems like a good candidate for
                        a protagonist. As the story progresses, however, we see that his motivations are not rooted in
                        some moral core, but only in his own self-interest. He takes no issue with scapegoating his
                        friends or abusing the lower castes. He chooses to remain an agent of the system as long as it
                        fits his needs. He merely is a plot device that introduces John to his world, the character that
                        creates meaningful tension with the status quo, coming from outside of the system and later
                        engulfed by it. John comes from a more traditional culture, even backwards in some respects.
                        This creates an excellent counter to the hyper-modern world of England. This places the reader
                        in the temporal and moral middle ground. A place where they are prepared to understand both
                        John's and Mond's opinions.
                    </p>
                    <p>

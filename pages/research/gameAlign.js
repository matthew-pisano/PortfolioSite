...
class GameAlign extends Component {
    ...
    render() {
        let tiles = [
            {
                title: "#Overview",
                content: `Here, I developed a text-based games benchmark, based on Microsoft's TextWorld environment.  As part of
            ...
            },
            {
                ...
                content: `We introduce a benchmark for the evaluation of large language models on moral values and business principles.  
            ...
            {
                title: "Background",
                content: `I worked on this project as a part of my 2023 research externship with IBM Research.  I worked with a small team of 
                    collaborators and mentors to better learn about model fine-tuning and text-based games.`,
            },
            {
                title: "Benchmark Composition",
                content: `The topics from within these games are based off of the five moral axes presented by 
            ...
            {
                title: "Models",
                content: `We use five models to evaluate the effectiveness of our benchmark.  These are
                    <ul>
                        <li>Flan-UL2</li>
                        <li>Flan-T5</li>
                        <li>Falcon</li>
            ...
            {
                title: "Evaluation",
                content: `To evaluate our benchmark, we use two different methods on different models.  The first method we use is instruction-tuning.
            ...
            },
            {
                ...
                gallery: true,
                content: `Our control results showed the Flan models performing the best at the games, an approximately equal win-loss ratio.  The other
                    models performed notably worse, often scoring in the negatives for most games.`,
                thumbnail: "/media/image/tw-llm-all-all-games.png"
            },
            {
                title: "Instruction-Tuning Results",
                gallery: true,
                content: `After including our game samples as instruction-tuning, the models performed notably better.  This is especially 
            ...
            },
            {
                title: "Control Results",
                gallery: true,
                content: `After fine-tuning our Flan-t5 small model, its performance rose notably as well.  Despite only being a fraction of the size

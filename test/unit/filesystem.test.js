...
function getTestDirectories() {
    let pageFiles = [
        new File("testFile1", "testContent1"),
    ...
    return [
        new Directory("testDir1", [
            pageFiles[0],
            pageFiles[2],
            new Directory("testDir2", [pageFiles[1]]),
            new Directory("testDir3", [pageFiles[3]])
        ]),
        new Directory("testDir1", [
            pageFiles[0],
            new File("testCustomFile1", "testCustomContent1"),
            new Directory("testDir2", [pageFiles[1], new File("testCustomFile2", "testCustomContent2")]),
            new Directory("testCustomDir1", [new File("testCustomFile3", "testCustomContent3")])
        ])
    ];
}

                ...
                <div id="tileHolder" className="inner w3-display-container">
                    ...
                    <div id="tile3" className="displayTile w3-container w3-row">
                        ...
                        <div className="w3-col w3-mobile w3-row">
                            ...
                            <div className="w3-col tag academicTag w3-mobile"><img className="w3-col" alt='academic'/><span className="w3-col"></span></div>
                            <div className="w3-col tag assemblyTag w3-mobile"><img className="w3-col" alt='assembly'/><span className="w3-col"></span></div>
                        </div>
                    </div>
                    <div id="tile4" className="displayTile w3-container w3-row">
                        ...
                        <div className="w3-col w3-mobile w3-row">
                            ...
                            <p>Java program that assembles one image from many smaller image.<br/>
                                ...
                                in that spot.</p>
                            <div className="gitLink w3-row w3-mobile w3-col"><img className="w3-col" alt='gitLink'/><a className="w3-col" href="https://github.com/ReactorDevelopment/InceptionCollage">Ineption Collage</a></div>
                            <div className="w3-col tag personalTag w3-mobile"><img className="w3-col" alt='personal'/><span className="w3-col"></span></div>
                            <div className="w3-col tag javaTag w3-mobile"><img className="w3-col" alt='java'/><span className="w3-col"></span></div>
                        </div>
                    </div>
